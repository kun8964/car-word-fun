...
const zones = [
  {
    ...
    vehicleId: "audi-a4",
    bg: "linear-gradient(145deg, #eef6ff, #ffffff)"
  },
  {
    id: "track",
    title: "赛车场",
    ...
    bg: "linear-gradient(145deg, #fff3d3, #ffffff)"
  },
  {
    id: "site",
    title: "工地",
    ...
    vehicleId: "excavator",
    bg: "linear-gradient(145deg, #fff0df, #ffffff)"
  },
  {
    id: "airport",
    title: "机场",
    ...
    bg: "linear-gradient(145deg, #e9fbff, #ffffff)"
  },
  {
    id: "garage",
    title: "车库",
    ...
    vehicleId: "beetle",
    bg: "linear-gradient(145deg, #f1efff, #ffffff)"
  }
];
